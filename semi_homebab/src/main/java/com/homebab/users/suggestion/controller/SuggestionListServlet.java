 ...
 */
@WebServlet("/suggestion/users/list")
public class SuggestionListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totalCount = suggestionService.selectTotalCount(searchMap);
		...
		List<SuggestionDTO> suggestionList = suggestionService.selectAllSuggestionList(selectCriteria);
		...
		if(suggestionList != null) {
			path = "/WEB-INF/views/users/suggestion/suggestionList.jsp";
