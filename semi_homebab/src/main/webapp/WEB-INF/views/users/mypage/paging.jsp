...
<body>
	...
	$("#myrecipe").click(function(){
	   ...
	   link = "${ pageContext.servletContext.contextPath }/myrecipe/page";
		console.log("링크타기 성공. ")
	...
	$("#mypost").click(function(){
		...
		link = "${ pageContext.servletContext.contextPath }/mypost/page";
		
		
	});
	
	$("#mysuggestions").click(function(){
		
		link = "${ pageContext.servletContext.contextPath }/mysuggestions/page";
	});
