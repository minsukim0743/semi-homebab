...
/**
 * <pre>
 * 나의 건의사항 게시물 조회하기 서블릿 
 * </pre>
 */
@WebServlet("/mysuggestions/page")
public class MySuggestionsPageServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totalCount = myPostService.selectSuggestionsTotalCount(loginUserIdx);
		...
		/* 조회해온다 */
		List<MySuggestionsDTO> myRecipeList = myPostService.selectSuggestionsList(map);	
		...
		if(myRecipeList != null) {
			...
			request.setAttribute("type", "mySuggestions");
