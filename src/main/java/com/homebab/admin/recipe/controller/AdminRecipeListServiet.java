 ...
 */
@WebServlet("/adminRecipe/list")
public class AdminRecipeListServiet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totalCount = service.adminRecipeListCount(searchMap);
		...
		List<AdminRecipeListDTO> adminRecipeList = service.adminRecipeListSelect(selectCriteria);
		...
		if(adminRecipeList != null) {
			...
			path = "/WEB-INF/views/admin/recipe/adminRecipelist.jsp";
