...
<body>
	...
	<script>
		...
		const link = "${ pageContext.servletContext.contextPath }/recipeComments/view";
		let searchText = "";
		...
		if(document.getElementById("startPage")) {
			...
			$startPage.onclick = function() {
				location.href = link + "?rcpIdx=${ recipe.rcpIdx }?currentPage=1" + searchText;
			}
		}
		...
		if(document.getElementById("prevPage")) {
			...
			$prevPage.onclick = function() {
				location.href = link + "?rcpIdx=${ recipe.rcpIdx }?currentPage=${ requestScope.selectCriteria.pageNo - 1 }" + searchText;
			}
		}
		...
		if(document.getElementById("maxPage")) {
			...
			$maxPage.onclick = function() {
				location.href = link + "?rcpIdx=${ recipe.rcpIdx }?currentPage=${ requestScope.selectCriteria.maxPage }" + searchText;
			}
		}
		
		function pageButtonAction(text) {
			location.href = link + "?rcpIdx=${ recipe.rcpIdx }?currentPage=" + text + searchText;
		}
	</script>
</body>
</html>