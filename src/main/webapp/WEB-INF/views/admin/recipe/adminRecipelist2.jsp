...
<body>
	...
	<div class="centertable">
		<form id="recipeListForm" action="${ pageContext.servletContext.contextPath }/adminRecipe/list2" method="get">
            ...
            <c:forEach var="recipe" items="${ requestScope.adminRecipeList }">
            	<tr height=41px>
                	...
                	<th width="50">
	                	<form id="recipeUpdateForm" action="${ pageContext.servletContext.contextPath }/adminRecipe/update/stateNy2" method="get">
                	...
                	<th width="50">
	                	<form id="recipeUpdateForm2" action="${ pageContext.servletContext.contextPath }/adminRecipe/update/stateYn2" method="get">
            ...
            <div class="alluserlistfooter">
				<jsp:include page="../paging/recipeListPaging2.jsp"/> 
           	</div>
        </div>
        <script>
		...
		if(document.getElementsByTagName("td")) {
			...
			for(let i = 0; i < $tds.length; i++) {
				...
				$tds[i].onclick = function() {
					...
					newWindow.location.href = "${ pageContext.servletContext.contextPath }/adminRecipe/detailN?rcpIdx="+number;
				}
